...
colors_tiles <- c("lightblue", "blue", "darkblue", "purple", "black")

# Define my own breaks for our scaling for the difference plot
breaks_diff <- c(0.1, 0.3, 0.5)
colors_diff <- c("lightblue", "blue", "darkblue", "purple", "black")
...
plot(diff_rast, main = "Difference", col = terrain.colors(50), breaks=breaks_diff)
