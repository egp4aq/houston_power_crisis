...
highways_buffer <- st_buffer(highways, dist = 200)

# Union the buffered highways to create a single object representing all areas within 200 meters of highways
highways_buffer_union <- st_union(highways_buffer)

# Exclude the areas within 200 meters of highways from the blackout mask
blackout_mask_no_highways <- st_difference(blackout_mask, highways_buffer_union)
